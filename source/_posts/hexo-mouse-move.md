---
title: Hexo + Butterfly 添加鼠标移动特效
date: 2023-03-03 16:37:22
tags:
  - Hexo
categories: Blog
---

1. 在`/themes/butterfly/source/js`文件夹中新建`mouse_move.js`文件
    ```js
    (function () {
      function t() {
        i(), a();
...
2. 在主题配置文件`_config.butterfly.yml`中的`inject`中的`bottom`引入下列`js`文件
    ```yaml
    - <script src="/js/mouse_move.js"></script>
    ```

    ![image-20230303164639360](https://images-1311785948.cos.ap-chengdu.myqcloud.com/typora/20230303164641.png)

3. 重新部署后效果如下：
    ![mouse_move](https://images-1311785948.cos.ap-chengdu.myqcloud.com/typora/20230303165013.gif)
